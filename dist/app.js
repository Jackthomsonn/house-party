...
},{"./transport":15,"./transports/index":16,"component-emitter":22,"debug":23,"engine.io-parser":26,"indexof":30,"parsejson":34,"parseqs":35,"parseuri":36}],15:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":11,"debug":23,"engine.io-parser":26,"parseqs":35,"xmlhttprequest-ssl":21,"yeast":73}],20:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":11,"debug":23,"engine.io-parser":26,"parseqs":35,"ws":8,"yeast":73}],21:[function(require,module,exports){
(function (global){
...
},{"./keys":27,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":6,"blob":7,"has-binary":28,"wtf-8":72}],27:[function(require,module,exports){
...
},{"./lib/index":51}],47:[function(require,module,exports){
'use strict';
...
},{"./random/random-from-seed":54}],48:[function(require,module,exports){
'use strict';
...
},{"./alphabet":47,"./encode":50}],49:[function(require,module,exports){
'use strict';
var alphabet = require('./alphabet');
...
},{"./alphabet":47}],50:[function(require,module,exports){
'use strict';
...
},{"./alphabet":47,"./build":48,"./decode":49,"./encode":50,"./is-valid":52,"./util/cluster-worker-id":55}],52:[function(require,module,exports){
'use strict';
var alphabet = require('./alphabet');
...
},{"./alphabet":47}],53:[function(require,module,exports){
'use strict';
...
},{"./on":58,"./socket":59,"backo2":5,"component-bind":9,"component-emitter":61,"debug":62,"engine.io-client":12,"indexof":30,"socket.io-parser":66}],58:[function(require,module,exports){
...
},{"./on":58,"component-bind":9,"component-emitter":61,"debug":62,"has-binary":28,"socket.io-parser":66,"to-array":71}],60:[function(require,module,exports){
(function (global){
...
},{"debug":62,"parseuri":36}],61:[function(require,module,exports){
arguments[4][22][0].apply(exports,arguments)
},{"dup":22}],62:[function(require,module,exports){
arguments[4][23][0].apply(exports,arguments)
},{"./debug":63,"_process":37,"dup":23}],63:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"dup":24,"ms":64}],64:[function(require,module,exports){
...
},{"./is-buffer":67,"isarray":31}],66:[function(require,module,exports){
...
},{"./binary":65,"./is-buffer":67,"component-emitter":10,"debug":68,"json3":33}],67:[function(require,module,exports){
(function (global){
...
},{"./events":75,"./notification":76,"./player":77,"./services":78,"./settings":79,"./view":80}],75:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var notification_1 = require("./notification");
var player_1 = require("./player");
    ...
    function Events() {
        ...
        this.createParty = function () {
            ...
            services_1.Services.createParty({
                ...
                _this.notification.show(result.name + " was successfully created", true);
                _this.view.hideLoader();
            }).catch(function (error) {
                _this.notification.show("" + error, true);
                _this.view.hideLoader();
            });
        };
        this.joinParty = function (e) {
            ...
            services_1.Services.partyExists(function (exists) {
                if (exists) {
                    ...
                    _this.view.hideLoader();
                    _this.notification.show("It looks like that party doesn't exist. Please make sure the ID you have supplied is correct", true);
                }
            });
        };
...
},{"./notification":76,"./player":77,"./services":78,"./settings":79,"./view":80}],76:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.hasEnded = function (audio) {
...
},{"./services":78,"./settings":79,"./view":80}],78:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require("jquery");
...
var Services = /** @class */ (function () {
    ...
    Services.getSongs = function (alternativeUrl) {
        var _this = this;
    ...
    Services.getPartyName = function (partyId) {
        return new Promise(function (resolve, reject) {
            $.ajax({
                method: 'GET',
    ...
    Services.requestSong = function (requestedSong) {
        ...
        return new Promise(function (resolve, reject) {
            _this.equalityCheck(requestedSong) ? reject('Song is already in queue') :
                resolve(_this.createRequest(requestedSong));
        });
    };
    Services.removeSong = function (songToRemove) {
        return new Promise(function (resolve, reject) {
            $.ajax({
                method: 'DELETE',
    ...
    Services.createParty = function (houseParty) {
        return new Promise(function (resolve, reject) {
            if (!houseParty.name) {
    ...
    Services.partyExists = function (callback) {
        var _this = this;
        $.ajax({
            method: 'GET',
            url: '/api/house-parties'
    ...
    Services.createRequest = function (requestedSong) {
        var _this = this;
        $.ajax({
            async: false,
            contentType: 'application/json; charset=utf-8',
...
},{"./settings":79,"jquery":32,"promise":38,"shortid":46}],79:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Promise = require("promise");
...
},{"./services":78,"promise":38,"socket.io-client":56}],80:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require("jquery");
var notification_1 = require("./notification");
...
var View = /** @class */ (function () {
    ...
    View.prototype.updateHeader = function (partyName) {
        this.header.html("" + partyName);
    };
    View.prototype.showSongRequestList = function (songs) {
        var _this = this;
        songs.map(function (song) {
            _this.songRequestList.append("<div class='card'>\n        <img src='" + song.image + "'></img>\n        <div class='info'>\n          <p>" + song.artist + "</p>\n          <p>" + song.songName + "</p>\n        </div>\n      </div>");
        });
        this.songRequestList.attr('style', 'visibility: visible');
        this.songRequestHeader.attr('style', 'visibility: visible');
    };
    View.prototype.closeSongRequestList = function () {
    ...
    View.prototype.updateSongQueue = function (song) {
        this.parent.append("<div class=\"card\">\n        <img src=\"" + song.image + "\"></img>\n        <div class=\"info\">\n          <p>" + song.artist + "</p>\n          <p>" + song.songName + "</p>\n        </div>\n      </div>");
    };
    View.prototype.removeSongFromQueue = function () {
        this.parent.find('.card').first().remove();
    };
    View.prototype.setCurrentSong = function (songs) {
        if (songs.length === 0) {
    ...
    View.prototype.closeSplash = function () {
        ...
        setTimeout(function () {
            _this.splash.hide();
            _this.outerBody.fadeIn(700);
        }, 700);
    };
    View.prototype.showCreatedParty = function (createdParty) {
        var _this = this;
        this.splashInput.addClass('slide-left');
        this.splashButton.addClass('slide-right');
        setTimeout(function () {
...
},{"./notification":76,"./services":78,"jquery":32}]},{},[74]);
